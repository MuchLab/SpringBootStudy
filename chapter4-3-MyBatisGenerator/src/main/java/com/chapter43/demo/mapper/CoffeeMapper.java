package com.chapter43.demo.mapper;
...
public interface CoffeeMapper {
    ...
    @Insert({
        ...
        "values (#{name,jdbcType=VARCHAR}, #{price,jdbcType=BIGINT,typeHandler=com.chapter43.demo.handler.MoneyTypeHandler}, ",
    ...
    @ResultMap("com.chapter43.demo.mapper.CoffeeMapper.BaseResultMap")
    ...
    @Update({
        ...
        "set name = #{name,jdbcType=VARCHAR},",
          "price = #{price,jdbcType=BIGINT,typeHandler=com.chapter43.demo.handler.MoneyTypeHandler},",
